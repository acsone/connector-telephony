...
PRIORITY_LIST = [("0", "0"), ("1", "1"), ("2", "2"), ("3", "3")]

CLASSES_LIST = [("0", "Flash"), ("1", "Phone display"), ("2", "SIM"), ("3", "Toolkit")]
...
class SmsAbstract(models.AbstractModel):
    ...
    classes = fields.Selection(
        selection=CLASSES_LIST, string="Class", default="1", help="The SMS class"
    )
    ...
    tag = fields.Char(help="an optional tag")
